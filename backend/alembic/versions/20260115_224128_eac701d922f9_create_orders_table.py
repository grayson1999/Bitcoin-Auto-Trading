...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "signal_id", sa.BigInteger(), nullable=True, comment="연관 AI 신호 ID"
        ),
        sa.Column(
            "order_type",
            sa.String(length=10),
        ...
        sa.Column(
            "side", sa.String(length=10), nullable=False, comment="주문 방향 (BUY/SELL)"
        ),
        ...
        sa.Column(
            "fee", sa.Numeric(precision=18, scale=8), nullable=True, comment="수수료"
        ),
        sa.Column(
            "upbit_uuid",
        ...
        sa.Column(
            "error_message", sa.Text(), nullable=True, comment="실패 시 오류 메시지"
        ),
        sa.Column(
            "created_at",
        ...
        sa.ForeignKeyConstraint(
            ["signal_id"], ["trading_signals.id"], ondelete="SET NULL"
        ),
